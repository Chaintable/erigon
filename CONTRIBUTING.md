...
This repository is a **fork**: upstream [erigontech/erigon](https://github.com/erigontech/erigon)
...
a general-purpose fork of erigontech/erigon.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v3.5.0-polygon-ct.4`); a GitHub Release publishes the versioned images
...
terms as this repository — see [COPYING](./COPYING) (LGPL-3.0).
